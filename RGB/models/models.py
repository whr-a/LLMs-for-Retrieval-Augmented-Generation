...
class Mistral:
    def __init__(self, plm) -> None:
        self.tokenizer = MistralTokenizer.from_file(f"{plm}/tokenizer.model.v3")
        self.model = Transformer.from_folder(plm)
    def generate(self, text, temperature=0.0, system = "", top_p=0.8):
